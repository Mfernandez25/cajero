...
const userSecond = 'Gera'
const passwordSecond = '1234'

const userThird = 'Maui'
const passwordThird = '12'
...
function validar(u,p){
    if(u === '' || p === ''){
        ...
        /*if(u === userSecond && p === passwordSecond){
            console.log('Bienvenido a tu cuenta');
            crear(userSecond)

        }
        if(u === userThird && p === passwordThird){
            console.log('Bienvenido a tu cuenta');
            crear(userThird)
